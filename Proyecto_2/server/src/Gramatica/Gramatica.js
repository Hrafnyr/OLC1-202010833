...
case 2:
            ...
            console.log("Error sintactico, no se esperaba: "+ yytext +" en linea " + _$[$0-1].first_line +", columna "+_$[$0-1].first_column );
            tablaErrores.push(["Error sintáctico","No se esperaba: "+yytext, _$[$0-1].first_line,_$[$0-1].first_column]);
...
case 4:
 this.$ = [$$[$0]];
break;
case 5: case 6: case 7: case 8: case 9: case 10: case 13: case 18: case 20:
  this.$ = $$[$0-1];  
break;
case 11:
  this.$ = ["BREAK"];  
...
case 72: 
        ...
        tablaErrores.push(["Error léxico","No se reconoce: "+yy_.yytext,yy_.yylloc.first_line,yy_.yylloc.first_column]); 
